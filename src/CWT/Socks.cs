...
namespace TheEscort
{
    public class Socks : Escort
    {
        ...
        public World SockWorld { get; set; }
        ...
        public void Escat_generate_backpack(Player owner)
        {
            ...
            AbstractCreature ac = new(
                this.SockWorld, StaticWorld.GetCreatureTemplate(CreatureTemplate.Type.TubeWorm),
            ...
            {
                1 => new LauncherBackpack(ac, this.SockWorld),
                _ => new GrappleBackpack(ac, this.SockWorld)
            };
            ac.InitiateAI();
            ac.RealizeInRoom();
